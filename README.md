...
- Then you can run the app by the command "npm start" and the app will run locally (localhost:3000).
...
NOTICE: The allowed math operators are: ADD, SUBTRACK, MULTIPLY, DIVIDE. other will get error 400.
